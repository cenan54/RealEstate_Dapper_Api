...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class WhoWeAreDetailController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteWhoWeAreDetail(int id)
        {
            ...
            return Ok("Başarılı bir şekilde hakkımızda kısmı silindi!");
        }

        [HttpPut]
        public async Task<IActionResult> UpdateWhoWeAreDetail(UpdateWhoWeAreDetail updateWhoWeAreDetail)
        {
            _whoWeAreDetailRepository.UpdateWhoWeAreDetail(updateWhoWeAreDetail);
            return Ok("Başarılı bir şekilde hakkımızda kısmı güncellendi!");
        }
