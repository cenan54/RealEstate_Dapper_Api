...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        [HttpGet("GetProductAdvertsListByEmployeeByTrueAsync")]
        public async Task<IActionResult> GetProductAdvertsListByEmployeeByTrueAsync(int id)
        {
            var values = await _productRepository.GetProductAdvertsListByEmployeeByTrueAsync(id);
            return Ok(values);
        }

        [HttpGet("GetProductAdvertsListByEmployeeByFalseAsync")]
        public async Task<IActionResult> GetProductAdvertsListByEmployeeByFalseAsync(int id)
        {
        ...
        public async Task<IActionResult> CreateProduct(CreateProductDto createProductDto)
        {
            ...
            return Ok("Başarılı bir şekilde ilan eklendi.");
        }
